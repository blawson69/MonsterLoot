...
The exact tools needed, along with other ingredients/items needed, the time necessary for crafting, etc. are all up to the GM and are intentionally vague in the item description to allow for all possibilities. If you haven't developed your own rules for crafting, a good resource is [Item Crafting Rules for 5e](https://www.dmsguild.com/product/210083/Item-Crafting-Rules-for-5e) by Charles Stapleford (I get no kick backs on any sales).
