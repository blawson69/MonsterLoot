...
var MonsterLoot = MonsterLoot || (function () {
    ...
    commandLootBody = function (msg) {
        ...
        if (is_npc) {
            ...
            var actions = _.filter(charAttrs, function (attr) {
                ...
                && attr.get('current').match(/(?:\(recharge|\(costs|day\)).*$/i) == null;
            });
    ...
    commandConfig = function (msg) {
        ...
        if (state['MonsterLoot'].useMarker) {
            ...
            //message += '<div style="text-align: center;"><a style="' + styles.textButton + '" href="!spoils --set-marker &#63;&#123;Token Marker&#124;&#125;" title="Set marker manually">Set manually</a></div>';
    ...
    commandExport = function () {
        ...
        if (!bestiary) createObj("handout", {name: 'Exported Bestiary'});
        if (bestiary) {
            var parsedData = '';
