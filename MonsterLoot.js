...
var MonsterLoot = MonsterLoot || (function () {
    ...
    NATURAL_WEAPONS = ['multiattack', 'unarmed strike', '.*sneak attack', 'bite', 'beak', 'claw', 'tail', 'fist', '.*rock', 'constrict', 'tusk', 'hooves', 'horns', 'crush', 'slam', 'talons', 'gore', 'stomp', 'ram', 'maul', '.*touch', '.*visage', '.*presence', '.*kiss', '.*drain', '.*sight', '.*form', '.*leap', '.*cloud', '.*breath', 'devour', 'swallow', '.*roar', 'tentacle', 'tendril', '.*spore', 'sting', 'spit', 'fling', 'cantrip', 'spell', 'pseudopod', 'shock', 'invisibility', 'charm', 'etherealness', '.*spine', 'hook', 'drop', 'proboscis', 'leadership', 'pincer', 'antennae'],
